...
An active bath denotes a suspension of self-propelled swimmers. 
It is analogous to a thermal bath like water, in that immersed passive objects are "agitated" in both.
In a thermal bath, e.g. water, such agitation is a result of randomly jiggling atoms kicking on the passive object, which is also known as Brownian motion \cite{Einstein1905}.
In an active bath, e.g. bacterial suspension, such agitation comes from passive-active interactions. 
In an early and seminal experiment, Wu and Libchaber found that a micron-sized particle, when immersed in bacterial suspensions at room temperature, diffused much farther as if it was immersed in a thermal bath 100 times hotter \cite{Wu2000}.
Enhanced diffusion of passive particles, from then on, became a defining feature of an active bath, of which the underlying mechanism has been under intense investigations and is still not fully resolved \cite{Bechinger2016}.
