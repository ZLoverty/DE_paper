...
We can roughly estimate the critical inner droplet radius, below which bacterial activity can overcome can buoyant force.
...
In our data, exponential tails are also observed when $\Delta t = 0.02, 0.08, 0.14$ s.
