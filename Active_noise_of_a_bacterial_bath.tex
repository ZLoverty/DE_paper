...
\textcolor{blue}{
In this section, we report the results from numerical simulation of droplet motions. 
The idea is to align some simulation results with experimental results, e.g. confinement effect. 
